  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        <h2 className="text-3xl font-black tracking-tighter text-gray-900 uppercase">Welcome Back</h2>
      ...
      <form className="space-y-6" action="#" method="POST">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link href="#" className="text-[13px] font-bold text-blue-600 hover:text-blue-500">
              Forgot password?
            </Link>
          </div>
          <input
      ...
      <div className="grid grid-cols-2 gap-4">
        <button className="flex justify-center items-center py-4 border border-gray-100 rounded-2xl hover:bg-gray-50 transition-colors group">
          <span className="text-[13px] font-black uppercase tracking-widest text-gray-900">Google</span>
        </button>
        <button className="flex justify-center items-center py-4 border border-gray-100 rounded-2xl hover:bg-gray-50 transition-colors group">
          <span className="text-[13px] font-black uppercase tracking-widest text-gray-900">GitHub</span>
        </button>
      </div>
